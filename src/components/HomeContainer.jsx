  ...
  return (
    ...
    id="home">
      <div className="py-2 flex-1 flex-col items-start justify-center gap-6">
        ...
        <p
          className="text-[2.5rem] font-bold tracking-wide
      lg:text-[4.5rem]
       text-headingColor"
        >
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        gap-4 flex-wrap lg:px-32 lg:pl-48">
           {
               heroData && heroData.map(n => (
                <div key = {n.id}
                 className=" lg:w-190 min-w-[190px] p-4 bg-cardOverlay backdrop-blur-md rounded-3xl
                flex flex-col items-center justify-center drop-shadow-lg">
                    ...
                    <p className=" text-[12px] lg:text-sm text-lightTextGray font-semibold mt-1 lg:my-3">
                        {n.decp} 
                    </p>

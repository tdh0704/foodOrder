  ...
  return (
    ...
    >
      ...
      >
         {/* cart item section*/}
        <div
          className="w-full h-340 md:h42 px-6 py-10 flex flex-col 
        ...
        >
          ...
          >
            <img
              src="https://firebasestorage.googleapis.com/v0/b/foodwebsite-f8e42.appspot.com/o/Images%2F1667054219983-f8.png?alt=media&token=3b341181-2029-42a0-a105-c429f482d115"
              alt=""
            ...
            >
              ...
              flex items-center justify-center ">1</p>
      ...
      {/* cart total section */}
        ...
        flex flex-col items-center justify-evenly px-8 py-2">
          ...
          whileTap={{scale : 0.8}}
          type = "button"
          className="w-ful p-2 rounded-full bg-gradient-to-tr from-orange-400 
